...
type RoutesStreamsService streamsService
...
func NewRoutesStreamsService(client *Client) *RoutesStreamsService {
	return &RoutesStreamsService{client, types.Routes}
}
...
type RoutesStreamsGetCall struct {
	streamsGetCall
}
...
func (s *RoutesStreamsService) Get(segmentEffortId int64, types []StreamType) *RoutesStreamsGetCall {
	call := &RoutesStreamsGetCall{}
